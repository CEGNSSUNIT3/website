...
const SUPABASE_URL    = 'https://cpkrfsrysgczdoctltlh.supabase.co';        // e.g. https://xxxx.supabase.co
const SUPABASE_KEY    = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNwa3Jmc3J5c2djemRvY3RsdGxoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MzQwNTk2OCwiZXhwIjoyMDg4OTgxOTY4fQ.VdOdZQoIBy_3Z60r7o3ScGvzCf4z_0i-sD0wwq2Qclo';    // Settings → API → service_role
